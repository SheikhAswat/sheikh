 ...
 * @author CW
 */
class GamerCompetitor extends Competitor {
    private int[] gamingScores;

    public GamerCompetitor(int competitorNumber, Name competitorName, String level, int age, String country, int[] gamingScores) {
